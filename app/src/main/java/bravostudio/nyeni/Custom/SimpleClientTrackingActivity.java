...
import bravostudio.nyeni.AR.CustomSurfaceView;
import bravostudio.nyeni.AR.Driver;
import bravostudio.nyeni.AR.GLRenderer;
...
public class SimpleClientTrackingActivity extends Activity implements ClientTrackerEventListener, ExternalRendering {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WikitudeSDKStartupConfiguration startupConfiguration = new
                WikitudeSDKStartupConfiguration(NyeniConstant.WIKITUDE_SDK_KEY, CameraSettings
                .CameraPosition.BACK, CameraSettings.CameraFocusMode.CONTINUOUS);
